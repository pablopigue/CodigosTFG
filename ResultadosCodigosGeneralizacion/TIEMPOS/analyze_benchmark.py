...
# Renombrar WGAN -> WGAN-MLP para consistencia con cambio de nombre
df["model"] = df["model"].replace({"WGAN": "WGAN-MLP"})
MODEL_ORDER = ["Vanilla GAN", "DCGAN", "DCGAN+LS", "WGAN-MLP", "WGAN-Conv", "WGAN-GP"]
...
arch_map = {m: "MLP" if m in ("Vanilla GAN", "WGAN-MLP") else "CNN"
