...
CRITIC_ITERATIONS = 5
WEIGHT_CLIP = 0.01   # Fiel al paper original de Arjovsky et al.
...
class Critic(nn.Module):
    def __init__(self):
        ...
        # BatchNorm en el crítico, fiel al paper original de WGAN que reutiliza
        # la arquitectura DCGAN completa.
